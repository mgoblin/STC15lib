...
# Import STC15 lib as a CMake or PlatformIO Project
...
On the next step, select an import as a CMake Project or PlatformIO Project 
on your preference.

After importing the project, you should configure the project to use 
SDCC compiler. 

Open clion/sdcc_compiler_clion.yaml and modify include-dirs if needed.
...
Expand editbox below "Edit errors and warnings from clang" and add at the end of the list
on new lines.
