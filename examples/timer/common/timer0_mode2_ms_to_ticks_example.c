/**
 * @file timer0_mode2_ms_to_ticks_example.c
 ...
 * corresponding number of timer ticks for Timer0 in Mode 2 (8 bit timer).
 * 
 ...
 * timer0_mode2_ms_to_ticks() function. It then starts the timer and outputs the
 ...
 * @see timer0_mode2_to_ms.h - Header containing ms to ticks conversion functions
 * 
 */
...
void main()
{
    ...
    uint16_t ticks = timer0_mode2_ms_to_ticks(DURATION_MS);
