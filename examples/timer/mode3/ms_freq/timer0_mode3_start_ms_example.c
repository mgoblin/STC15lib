/**
 * @file timer0_mode3_start_ms_example.c
 * @brief Example demonstrating Timer0 Mode 3 operation with millisecond-based timing
 * 
 * This example shows how to use Timer0 in Mode 3 (16-bit timer mode) with
 * millisecond-based configuration. It demonstrates the timer0_mode3_start_ms()
 ...
 * - Starting Timer0 with millisecond duration using timer0_mode3_start_ms()
...
/**
 * @brief Main function for Timer0 Mode 3 millisecond timing example
 * 
 ...
 * 
 * Operation flow:
 * 1. Configure Timer0 in Mode 3 with 12T timing (one timer count per 12 clock cycles)
...
void main(void)
{
    ...
    timer0_mode3_start_ms(TIMER_DURATION_MS);
