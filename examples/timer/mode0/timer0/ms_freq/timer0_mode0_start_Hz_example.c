/**
 * @file timer0_mode0_start_Hz_example.c
 * @brief Example demonstrating Timer0 Mode 0 operation with frequency-based timing
 * 
 * This example shows how to use Timer0 in Mode 0 (16-bit timer mode) with
 * frequency-based configuration. It demonstrates the timer0_mode0_start_Hz()
 ...
 * - Starting Timer0 with frequency in Hertz using timer0_mode0_start_Hz()
 ...
 * @see timer0_mode0_to_ms.h - Header containing frequency-based timer functions
 * @see timer0_mode0_Hz_to_ticks - Function for manual Hz to ticks conversion
 * 
 */
...
/**
 * @brief Main function for Timer0 Mode 0 frequency-based timing example
 * 
 ...
 * 
 * Operation flow:
 * 1. Initialize Timer0 in Mode 0 with 12T timing (one timer count per 12 clock cycles)
