...
board = STC15W408AS
lib_deps = mgoblin/STC15 hardware@^0.10.0
```
Where is 0.10.0 STC15 hardware library version.
...
platform = intel_mcs51
board = STC15W408AS
lib_deps = https://github.com/mgoblin/STC15lib#0.10.0
```

Where is 0.10.0 STC15 hardware library github tag version.
