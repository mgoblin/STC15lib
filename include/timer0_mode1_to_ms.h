#ifndef STC15_TIMER0_MODE1_TO_MSH
#define STC15_TIMER0_MODE1_TO_MSH

/**
 * @file timer0_mode1_to_ms.h
 * @defgroup timer0_mode1_to_ms Timer0 Mode1 ticks to duration/frequency convertions
 * @details Functions and data structures for converting timer ticks 
 * to frequency and times for timer0 mode1.
 * 
...
/**
 * @brief Converts ticks to timer overflow frequency for timer0 mode1.
...
/**
 * @brief Converts frequency to ticks for timer0 mode1. 
 * @details Call this method after timer0 is initialized and MCU clock frequency divider scale is set.
 * 
 * @warning This method returns 0 on ticks overflow of result. Be careful.
 * 
 ...
 * @ingroup timer0_mode1_to_ms
 */
#define timer0_mode1_frequency_to_ticks(frequency) (timer_frequency_to_ticks(frequency, get_timer0_clock_divider(), get_frequency_divider_scale()))
