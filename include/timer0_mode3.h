 ...
 * @ingroup timer0_mode3
 */
#define timer0_mode3_enable_P35_output(enable) (enable ? bit_set(INT_CLKO, 0) : bit_clr(INT_CLKO, 0))
 ...
 * @ingroup timer0_mode3
 */
#define is_timer0_mode3_P35_output_enabled() (test_if_bit_set(INT_CLKO, 0))
 ...
 * @ingroup timer0_mode3
*/
#define timer0_mode3_close_gate() (bit_set(TMOD, 3))
 ...
 * @ingroup timer0_mode3
*/
#define timer0_mode3_open_gate() (bit_clr(TMOD, 3))
 ...
 * @ingroup timer0_mode3
 */
#define is_timer0_mode3_gate_opened() (test_if_bit_cleared(TMOD, 3))
