...
/**
 * @file timer0_mode3.h
 * @defgroup timer0_mode3 Timer0 Mode3 basics
...
/**
 * @brief Reload timer0 mode3 TH0 and TL0 on the fly
 * @details Reload is available in modes 0, 2, 3.
 * 
...
/**
 * @brief Run timer0 in mode3 with direct set of TH0 and TL0 registers.
 * @details Before run timer0_mode3_12T_init or timer0_mode3_1T_init should be called.
 * 
 * After run program flow not blocked and interrupt will raised when timer is overloaded.
 * Interrupt handler 
 ...
 * 
 * Dont mix call timer0_mode3_direct_start call with
 * void timer0_mode3_delay call
 * 
 * @param th0 uint8_t TH0 value
 * @param tl0 uint8_t TL0 value 
...
do {                                                                                    \
    timer0_mode3_direct_reload(th0, tl0);                                               \
                                                                                        \
    TF0 = 0;                                                                            \
    TR0 = 1;                                                                            \
} while(0)
